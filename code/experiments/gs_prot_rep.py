...
from config import RAW_DLKCAT, SEQ_LOOKUP, BS_PRED_DIRS, CONFIGS
...
def main():
    ...
    # fold_indices = list(kf.split(sequences))
    ...
    for split_mode in split_modes:
        ...
        for cfg in CONFIGS:
            ...
            seq_vec = sequences_to_features(
                sequences, binding_site_df, seq_to_id,
    ...
    df_metrics.to_csv(f"/home/msp/saleh/KinForm/results/prot_rep_gs.csv_{dataset}", index=False)
    pd.to_pickle(all_results, f"/home/msp/saleh/KinForm/results/prot_rep_gs_{dataset}.pkl")
